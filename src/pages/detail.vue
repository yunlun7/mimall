    ...
    <div class="wrapper">
      <div class="container clearfix">
        ...
        <div class="content">
          ...
          <div class="item-price">{{product.price}}<span class="del">1299</span></div>
          <div class="line"></div>
          <div class="item-addr">
            <i class="icon-loc"></i>
          ...
          <div class="item-total">
            <div class="phone-info clearfix">
              ...
              <div class="fr">{{product.name}}元</div>
            </div>
            <div class="phone-total">总计：{{product.name}}元</div>
          </div>
          <div class="btn-group">
...
export default{
  ...
  methods: {
    getProductInfo () {
      // let id = this.$route.params.id  //直接在data中定义就不需要写了
